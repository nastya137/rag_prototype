...
Данный проект представляет собой прототип Retrieval-Augmented Generation (RAG) системы для ответов на вопросы по методическим документам предприятия. Система состоит из:
